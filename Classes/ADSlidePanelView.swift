...
open class Item: NSObject {
 ...
 class ADSlidePanelTableViewCell: UITableViewCell {
...
/** Protocol for side panel. */
 public protocol ADSlidePanelViewDelegate {
...
open class ADSlidePanelView: UIView {
    ...
    var delegate: ADSlidePanelViewDelegate?
    ...
    override open func awakeFromNib() {
        ...
        self.menuTView.register(UINib.init(nibName: "ADSlidePanelTableViewCell", bundle:bun ), forCellReuseIdentifier: "ADSlidePanelTableViewCell")
 ...
 */
 ...
 open class func initMenuView(_ contents: [Item], slideDirection: Direction?, delegate: ADSlidePanelViewDelegate ) -> ADSlidePanelView{
    
   let bun = Bundle(for: self.classForCoder())
       let sideView = bun.loadNibNamed("ADSlidePanelView", owner: self, options: nil)?.last as? ADSlidePanelView
        if sideView != nil {
...
extension ADSlidePanelView: UITableViewDelegate, UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "ADSlidePanelTableViewCell", for: indexPath) as? ADSlidePanelTableViewCell
